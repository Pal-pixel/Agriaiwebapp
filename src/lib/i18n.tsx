...
const EN: Dict = {
  ...
  'home.errInvalidImage': 'The uploaded image is not a crop leaf. Please choose a clean, well-lit crop leaf photo.',
  'res.back': 'Back',
...
const HI: Dict = {
  ...
  'home.errInvalidImage': 'अपलोड की गई छवि एक फसल की पत्ती नहीं है। कृपया एक साफ, अच्छी रोशनी वाली पत्ती की फोटो चुनें।',
  'res.back': 'वापस',
